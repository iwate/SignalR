...
namespace Microsoft.AspNet.SignalR.Samples
{
    public partial class Startup
    {
        public static void ConfigureSignalR(IDependencyResolver dependencyResolver, IHubPipeline hubPipeline)
        {
            ...
            dependencyResolver.UseServiceBus("sb://signalr-scaleout-sb-log.servicebus.windows.net/;SharedSecretIssuer=owner;SharedSecretValue=UyfsZP3RlHsJDtGva8bzsEUoCc8NrVXvIF1LcT2AAi4=", "Microsoft.AspNet.SignalR.Samples");
